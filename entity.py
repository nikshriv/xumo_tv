...
class HomeKitEntity(Entity):
    ...
    def available(self) -> bool:
        """Return True. Pioneer Xumo TV goes into deep sleep and shuts down it's wired 
        etherenet connection. This is handled by sending a magic packet at startup of 
        home assistant and when a power on command is sent through the media_player or remote
        component"""
        return True
